...
pub trait SemanticAnalyzer {
    ...
    fn resolve_type(&self, file: &Path, line: usize, column: usize) -> Result<Option<TypeInfo>>;

    /// Get all diagnostics for a file
    fn get_diagnostics(&self, file: &Path) -> Result<Vec<SemanticDiagnostic>>;
    ...
    fn find_references(&self, file: &Path, line: usize, column: usize) -> Result<Vec<SymbolInfo>>;

    /// Get hover information for a symbol
    fn get_hover(&self, file: &Path, line: usize, column: usize) -> Result<Option<String>>;
}
...
impl MockSemanticAnalyzer {
    ...
    pub fn add_diagnostic(&mut self, file: PathBuf, diagnostic: SemanticDiagnostic) {
        self.diagnostics.entry(file).or_default().push(diagnostic);
    }
...
impl SemanticAnalyzer for MockSemanticAnalyzer {
    fn resolve_type(&self, _file: &Path, _line: usize, _column: usize) -> Result<Option<TypeInfo>> {
    ...
    fn get_hover(&self, _file: &Path, _line: usize, _column: usize) -> Result<Option<String>> {
        // Mock implementation
